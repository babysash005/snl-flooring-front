      ...
      if(formData.Items.length > 1)
    {
      ...
      if(result.status === 200)
      {
       ...
       // LoadData(q);
        ...
        setPopUpMessage("Oops!!! , Unable to delete Quotation")
      }
    }else{
    ...
    try {
      ...
      if(VaildationCheck() === 2)
      {
        if(formData.Id === null || formData.Id === 0)
        {
          ...
          {
            LoadData(q);
            setPopUpMessage("Quotation Update Sucessfully")
          }else{
            setPopUpMessage("Oops !!!! Quotation failed to Update, try again later")
          }
        }
      ...
      <div className="relative top-2 right-[45rem] w-[60rem]">
        <div className="relative left-full">
          <div className="shadow overflow-hidden sm:rounded-md px-4 py-4 bg-blue-400 sm:p-6">
            ...
            <p className="mt-1 text-sm text-white">Build Quote For Customer</p>
          </div>
